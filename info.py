...
DATABASE_URI2 = environ.get('mongodb+srv://shebin:shebi_4618@cluster1.wovxqek.mongodb.net/?retryWrites=true&w=majority')  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
