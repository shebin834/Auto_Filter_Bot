...
DATABASE_URI2 = environ.get('mongodb+srv://shebin:shebin4618@cluster1.wovxqek.mongodb.net/test?retryWrites=true&w=majority')  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
