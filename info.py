...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://user:password@clustername.mongodb.net/dbname")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
