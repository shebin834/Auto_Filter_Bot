...
DATABASE_URI2 = environ.get('mongodb+srv://shebin:eOFYZRp6YiCzjtN6@cluster1.wovxqek.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1')  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
