...
DATABASE_URI2 = environ.get('mongodb+srv://shebin:Shebin%40123@cluster1.wovxqek.mongodb.net/?appName=Cluster1')  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
