...
DATABASE_URI2 = environ.get('mongodb+srv://shebinkallankunnan_db_user:EszARQU7AQlxnKxR@cluster2.yqqambl.mongodb.net/?appName=Cluster2')  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
