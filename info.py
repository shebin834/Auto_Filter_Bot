...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shebin:shebin123@cluster0.hunvcay.mongodb.net/myDatabase?retryWrites=true&w=majority")  # MongoDB URI for the database
