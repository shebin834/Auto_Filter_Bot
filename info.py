...
# ============================
SESSION = environ.get('SESSION', 'spiderman_search')   # Session name for the bot
...
BOT_TOKEN = environ.get('BOT_TOKEN', "6129144336:AAHY4XHjUj7gdxvP5SHf_ttP8iuzB91Z8xc")    # Bot token from @BotFather
...
PICS = (environ.get('PICS','https://graph.org/file/32eebd761ec6f46c09ac0-875fd9d7b055c84b80.jpg https://graph.org/file/0cdccfbaba849dc17ebf5-1bf153bf29616c375f.jpg https://graph.org/file/aea827b245bf4e03b5f82-d75d663fc2fd7c6f21.jpg https://graph.org/file/9f9ccc17f58828e5bfe6d-785ac0f08c59e7b657.jpg https://graph.org/file/01726bbb5c3a06f8a1ce5-0d159506ae99895050.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/a224fbff472c66807eccb-0ff91a6f7a49c9144b.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5079722109').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003895931534 -1001794709970').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003887101189'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003862990949'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003887101189'))  # Premium logs channel id
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/movi_clubb")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/MalluTheaterLinkz")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/MalluTheaterLinkz")   # Third tutorial link for verification
