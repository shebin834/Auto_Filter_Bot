...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://shebin:shebin4618@cluster1.wovxqek.mongodb.net/?appName=Cluster1")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
