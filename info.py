...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shebin:shebin%40123@cluster0.hunvcay.mongodb.net/myDatabase?appName=Cluster0")  # MongoDB URI for the database
